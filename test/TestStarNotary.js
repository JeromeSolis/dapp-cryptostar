...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(tokenName, 'Spacecoin');
    assert.equal(tokenSymbol, 'SUN');
});
...
it('lets a user transfer a star', async() => {
    ...
    let owner = await instance.ownerOf(starId1);
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let lookUpName = await instance.lookUptokenIdToStarInfo(starId);
